<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organized_Table_1_Table.aspx.cs" Inherits="College_Project__FILE_UPLOAD_.Organized_Table_1_Table" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <h2 style="color: white;">
                <u>(f) Seminar / Workshops / Confreres organised (if any):</u>
            </h2>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" Font-Bold="true" ForeColor="Red" ControlToValidate="YearTxt"></asp:RequiredFieldValidator>
            <br />
            <br />
            ...
            <asp:Label ID="Label8" runat="server" Text="Your Role: "></asp:Label>
            <asp:TextBox ID="YourRoleTxt" runat="server" Style='text-transform: uppercase'></asp:TextBox>
            <br />
            <br />
