...
{
    public partial class Publication_Journals_TABLE : System.Web.UI.Page
    {
        ...
        protected void Insert_Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                string checkRecord = "select count(*) from Publication_Journals_COLLEGEPROJECT_FILE_UPLOAD where Journal_Name = '" + Journal_Name_Text.Text + "' AND Publishing_Agency = '" + Publishing_Agency_Text.Text + "' AND Refereed = '" + Refereed_Text.Text + "' AND Teacher_ID = '" + IDLabel.Text + "' AND Non_Refereed = '" + Non_Refereed_Text.Text + "' AND Level = '" + Level_Text.Text + "' AND ChapterNo = '" + ChapterNo_Text.Text + "' AND ChapterNo_Name = '" + Chapter_Name_Text.Text + "' AND ChapterNo_PageNo = '" + PageNo_Text.Text + "';";
                    ...
                    if (FileUpload1.HasFile)
                    {
                        ...
                        if (filesize < 20728650)    //20MB
                        {
                            ...
                            using (SqlConnection con = new SqlConnection(strCon))
                            {
                                ...
                                {
                                    cmd.CommandText = "insert into Publication_Journals_COLLEGEPROJECT_FILE_UPLOAD(Teacher_ID, Year, Journal_Name, Publishing_Agency, Refereed, Non_Refereed, Level, ChapterNo, ChapterNo_Name, ChapterNo_PageNo, FileName, Filetype, FileData, UploadedOn) values(@Teacher_ID, @Year, @Journal_Name, @Publishing_Agency, @Refereed, @Non_Refereed, @Level, @ChapterNo, @ChapterNo_Name, @ChapterNo_PageNo, @FileName, @Filetype, @FileData, @UploadedOn)";

                                    cmd.Parameters.AddWithValue("@Teacher_ID", IDLabel.Text);
                                    cmd.Parameters.AddWithValue("@Year", Year_Text.Text);
                                    cmd.Parameters.AddWithValue("@Journal_Name", Journal_Name_Text.Text.ToUpper());
                                    cmd.Parameters.AddWithValue("@Publishing_Agency", Publishing_Agency_Text.Text.ToUpper());
                                    cmd.Parameters.AddWithValue("@Refereed", Refereed_Text.Text.ToUpper());
                                    cmd.Parameters.AddWithValue("@Non_Refereed", Non_Refereed_Text.Text.ToUpper());
        ...
        private void BindGridviewData()
        {
            ...
            using (SqlConnection con = new SqlConnection(strCon))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "SELECT * FROM Publication_Journals_COLLEGEPROJECT_FILE_UPLOAD WHERE Teacher_ID =  @Teacher_ID";
                    cmd.Parameters.AddWithValue("@Teacher_ID", IDLabel.Text);
                    cmd.Connection = con;
                    con.Open();
        ...
        {
            Year_Text.Text = "";
            Journal_Name_Text.Text = "";
            Publishing_Agency_Text.Text = "";
            Refereed_Text.Text = " ";
            Non_Refereed_Text.Text = "";
            Level_Text.Text = "";
            ChapterNo_Text.Text = "";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                LecturerDataAccessLayerPublication_Journals.DeleteRecord(Convert.ToInt32(e.CommandArgument));
                BindGridviewData();
            ...
            else if (e.CommandName == "UpdateRow")
            {
                ...
                string Journal_Name = ((TextBox)GridView1.Rows[rowIndex].FindControl("Journal_NameEditTxt")).Text;

                string Publishing_Agency = ((TextBox)GridView1.Rows[rowIndex].FindControl("Publishing_AgencyEditTxt")).Text;

                string Refereed = ((TextBox)GridView1.Rows[rowIndex].FindControl("RefereedEditTxt")).Text;

                string Non_Refereed = ((TextBox)GridView1.Rows[rowIndex].FindControl("Non_RefereedEditTxt")).Text;
                ...
                LecturerDataAccessLayerPublication_Journals.UpdateRecord(S_No, Year, Journal_Name, Publishing_Agency, Refereed, Non_Refereed, Level, ChapterNo, ChapterNo_Name, ChapterNo_PageNo, FileName);
        ...
        protected void SearchBtn_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(strCon))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    {
                        sql = "SELECT * FROM Publication_Journals_COLLEGEPROJECT_FILE_UPLOAD WHERE Teacher_ID = '" + IDLabel.Text + "' AND( WHERE Year LIKE @SearchParameter + '%' OR Journal_Name LIKE @SearchParameter + '%' OR Publishing_Agency LIKE @SearchParameter + '%' OR Refereed LIKE @SearchParameter + '%' OR Non_Refereed LIKE @SearchParameter + '%' OR Level LIKE @SearchParameter + '%' OR ChapterNo LIKE @SearchParameter + '%' OR ChapterNo_Name LIKE @SearchParameter + '%' OR ChapterNo_PageNo LIKE @SearchParameter + '%' );";
                        cmd.Parameters.AddWithValue("@SearchParameter", SearchTxt.Text.Trim());
                    }
                    else
                    {
                        sql = "SELECT * FROM Publication_Journals_COLLEGEPROJECT_FILE_UPLOAD WHERE Teacher_ID = '" + IDLabel.Text + "';";
                    }
                    cmd.CommandText = sql;
                    cmd.Connection = con;
