...
{
    public partial class PostGraduateCourses_Table : System.Web.UI.Page
    {
        ...
        protected void Insert_Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                string checkRecord = "select count(*) from PostGraduateCourses_COLLEGEPROJECT_FILE_UPLOAD where Year = '" + Year_Text.Text + "' AND Class = '" + ClassTxt.Text + "'AND Paper = '" + PaperTxt.Text + "' AND Teacher_ID = '" + IDLabel.Text + "' AND Nomenclature = '" + Nomenclature_Text.Text + "' AND PeriodsPerWeek = '" + PeriodsPerWeek_Text.Text + "' AND Lecture_Method = '" + Lecture_Method_Text.Text + "' AND Seminar_Presentation_Method = '" + Seminar_Presentation_Method_Text.Text + "';";
                ...
                else
                {
                    using (SqlConnection con = new SqlConnection(strCon))
                    {
                        ...
                        {
                            cmd.CommandText = "insert into PostGraduateCourses_COLLEGEPROJECT_FILE_UPLOAD(Teacher_ID, Year, Class, Paper, Nomenclature, PeriodsPerWeek, Lecture_Method, Seminar_Presentation_Method, UploadedOn) values(@Teacher_ID, @Year, @Class, @Paper, @Nomenclature, @PeriodsPerWeek, @Lecture_Method, @Seminar_Presentation_Method, @UploadedOn)";
        ...
        private void BindGridviewData()
        {
            ...
            GridView1.DataSource = LecturerDataAccessLayerPostGraduateCourses.GetAllDetailsOfTheLecturers(Teacher_ID);
            GridView1.DataBind();
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                LecturerDataAccessLayerPostGraduateCourses.DeleteRecord(Convert.ToInt32(e.CommandArgument));
                BindGridviewData();
            ...
            else if (e.CommandName == "UpdateRow")
            {
                ...
                LecturerDataAccessLayerPostGraduateCourses.UpdateRecord(S_No, Year, Class, Paper, Nomenclature, PeriodsPerWeek, Lecture_Method, Seminar_Presentation_Method);
