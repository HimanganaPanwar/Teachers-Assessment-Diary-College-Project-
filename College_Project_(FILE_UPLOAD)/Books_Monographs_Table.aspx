<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Books_Monographs_Table.aspx.cs" Inherits="College_Project__FILE_UPLOAD_.Books_Monographs_Table" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <h2 style="color: white;">
                <u>(d) Publications: Books / Monogarphs:</u>
            </h2>
            ...
            <asp:Label ID="Label5" runat="server" Text="Sole Author Name: "></asp:Label>
            <asp:TextBox ID="Sole_Author_Name_Text" runat="server" Style='text-transform: uppercase'></asp:TextBox>
            <br />
            <br />

            <asp:Label ID="Label6" runat="server" Text="Co-Author Name (if any): "></asp:Label>
            <asp:TextBox ID="Co_Author_Name_Text" runat="server" Style='text-transform: uppercase'></asp:TextBox>
            <br />
            <br />

            <asp:Label ID="Label7" runat="server" Text="Publishing House / Agency: "></asp:Label>
            <asp:TextBox ID="Publishing_House_Text" runat="server" Style='text-transform: uppercase'></asp:TextBox>
            <br />
            <br />
            ...
            <asp:Label ID="Label9" runat="server" Text="Reference OR Text: "></asp:Label>
            <asp:TextBox ID="Reference_OR_Text_Text" runat="server" Style='text-transform: uppercase'></asp:TextBox>
            <br />
            <br />

            <asp:Label ID="Label10" runat="server" Text="ISSN/ISBN No. (if any): "></asp:Label>
            <asp:TextBox ID="ISSN_OR_ISBN_No_Text" runat="server" onkeypress="return numeric(event)"></asp:TextBox>
            <br />
            <br />
            ...
            &emsp;
            <asp:Button ID="ResetBtn" runat="server" Text="Resets" BackColor="LightGray" OnClick="ResetBtn_Click"/>
            <br />
            <br />
