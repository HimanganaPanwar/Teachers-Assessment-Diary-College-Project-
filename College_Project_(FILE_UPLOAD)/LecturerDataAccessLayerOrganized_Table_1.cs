...
{
    public class Lecturer_Organized_Table_1
    {
    ...
    public class LecturerDataAccessLayerOrganized_Table_1
    {
        ...
        public static void DeleteRecord(int S_No)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE FROM Organized_Table_1_COLLEGEPROJECT_FILE_UPLOAD WHERE S_No = @S_No", con);
        ...
        //UPDATE METHOD: 
        public static int UpdateRecord(int S_No, int Year, string Theme, string Date_Value, int Level, string YourRole, string FileName)
        {
            using (SqlConnection con = new SqlConnection(cs))
            {
                string updateQuery = "UPDATE Organized_Table_1_COLLEGEPROJECT_FILE_UPLOAD SET Year = @Year, " + "Theme = @Theme, Date_Value = @Date_Value, Level = @Level, YourRole = @YourRole, FileName = @FileName WHERE S_No= @S_No";
                ...
                SqlParameter paramYourRole = new SqlParameter("@YourRole", YourRole);
                cmd.Parameters.Add(paramYourRole);
