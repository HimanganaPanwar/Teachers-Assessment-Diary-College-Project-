<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Co_Curricular_Activities.aspx.cs" Inherits="College_Project__FILE_UPLOAD_.Co_Curricular_Activities" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" DefaultButton="Insert_Btn">
                ...
                <asp:Label ID="Label8" runat="server" Text="Has it Helped you and the student in professional development: "></asp:Label>
                <asp:TextBox ID="Helped_Text" runat="server" Style='text-transform: uppercase'></asp:TextBox>
                <br />
                <br />
